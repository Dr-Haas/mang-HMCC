...
export const CONTACT_PHONE = "01 43 44 52 22";
export const CONTACT_PHONE_ALT = "01 42 66 52 40";
export const CONTACT_ADDRESS_PARIS = "42 boulevard de la Bastille, 75012 Paris";
export const CONTACT_ADDRESS_PARIS_12 =
  "42 boulevard de la Bastille, 75012 Paris";
export const CONTACT_ADDRESS_ARPAJON =
  "11 bis boulevard Abel Cornaton, 91290 Arpajon, Essonne";
