  ...
  const advantages = [
    {
      ...
      description:
        "Une adresse professionnelle qui inspire confiance à vos clients et partenaires",
    },
    {
      icon: Eye,
      title: "Vie privée préservée",
      description:
        "Pas d'utilisation de votre adresse personnelle pour votre activité professionnelle",
    },
    {
      icon: MapPin,
      title: "Localisation stratégique",
      description:
        "Une adresse prestigieuse à Arpajon pour votre développement",
    },
    {
      icon: Zap,
      title: "Services additionnels",
      description:
        "Gestion de courrier, location d'espace de travail, permanence téléphonique",
    },
  ];
